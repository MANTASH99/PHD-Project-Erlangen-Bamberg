...
from transformers import (
    DistilBertTokenizerFast,        # <-- CHANGE HERE
    DistilBertForSequenceClassification, # <-- CHANGE HERE
    TrainingArguments,
    Trainer
)
import torch
...
# 3️⃣ Tokenizer setup
# ============================================================
model_name = "distilbert-base-uncased"  # <-- CHANGE HERE
print(f"\n🔹 Loading tokenizer: {model_name}")
tokenizer = DistilBertTokenizerFast.from_pretrained(model_name) # <-- CHANGE HERE
...
model = DistilBertForSequenceClassification.from_pretrained( # <-- CHANGE HERE
    model_name,
...
training_args = TrainingArguments(
    output_dir="models/distilbert-base-emotions", # <-- CHANGE HERE
    eval_strategy="epoch",
    save_strategy="epoch",
    learning_rate=2e-5,
    ...
    report_to="none",
    logging_dir="./logs_distilbert", # <-- CHANGE HERE (optional)
...
trainer.save_model("models/distilbert-base-emotions/final") # <-- CHANGE HERE

print("\n🎯 Model saved to: models/distilbert-base-emotions/final/") # <-- CHANGE HERE
print("Done ✅")